const seed = (db) => {
    ...
    const POST = [
        {id: 1, postImage:'/public/assets/dough-post.jpg', caption: "I lost some weight once, but I found it again in the fridge.", likes: 0, dislikes: 0, userId: 1},
        {id: 2, postImage:'/public/assets/dough-post.jpg', caption: "I love pizza. ...", likes: 0, dislikes: 0, userId: 2},
        {id: 3, postImage:'/public/assets/dough-post.jpg', caption: "I just want someone to look at me the way I look at food.", likes: 0, dislikes: 0, userId: 2},
        {id: 4, postImage:'/public/assets/dough-post.jpg', caption: "Sorry—I'm in a relationship. ...", likes: 0, dislikes: 0, userId: 1},
        {id: 5, postImage:'/public/assets/dough-post.jpg', caption: "Sugar, spice, and everything nice.", likes: 0, dislikes: 0, userId: 2},
        {id: 6, postImage:'/public/assets/dough-post.jpg', caption: "My milkshake brings all the boys to the yard.", likes: 0, dislikes: 0, userId: 1},
    ]
                ...
                .then(() => {
                    ...
                    return Promise.all([...ingredientPromises, ...profilePromises, ...postPromises])
                        .then(() => {
                            ...
                            // (another way to implement the associations between user and ingredients through fridge)
